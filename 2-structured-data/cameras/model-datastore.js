...
// Lists all cameras in the Datastore sorted alphabetically by title.
// The ``limit`` argument determines the maximum amount of results to
// return per page. The ``token`` argument allows requesting additional
// pages. The callback is invoked with ``(err, cameras, nextPageToken)``.
// [START list]
...
function update (id, data, cb) {
  ...
  const entity = {
    key: key,
    data: toDatastore(data, ['highlights'])
  };
